...
public class KmsEncryptDecryptExample {
    ...
    private static final String KEY_ID = "arn:aws:kms:ap-northeast-2:077672914621:key/8b4979f7-6012-45d8-88f4-dd4993d4b796";

    public static void main(String[] args) {
        String plainText = "Cruel queen, scene and the end";
